...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Daffodils " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"daffodilscoin.com", "188.166.151.162"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"daffodilscoin.com", "127.0.0.1"},
    {NULL, NULL}
};
...
unsigned int pnSeed[] =
{
    ...
    0x520f1d25, 0x37366c5f, 0x7594b159, 0x3804f23c, 0xb81ff054, 0x96dd32c6, 0x823528bc, 0xf4006e41,
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Daffodils is probably already running."), addrBind.ToString().c_str());
        else
